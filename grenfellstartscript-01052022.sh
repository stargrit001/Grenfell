...
#Fades for menyvideo
fadeout_vid () {
  cd /home/pi/omxplayer/
  counterout=254
  while [ $counterout -gt 6 ]
  do
    counterout=$(( $counterout - 5 ))
    ./dbuscontrol.sh setalpha $counterout
    sleep 0.05  
  done
}
...
fadein_vid () {
   cd /home/pi/omxplayer/
   counterin=1
   while [ $counterin -lt 249 ]
   do
     counterin=$(( $counterin + 5 ))
     ./dbuscontrol.sh setalpha $counterin
     sleep 0.05
   done
}
#-------------------------
